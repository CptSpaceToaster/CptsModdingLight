...
public class YellowColoredLightBlock extends Block {
	public YellowColoredLightBlock(int id) {
		...
		addColorLightValue(Block.l[15], Block.l[15], Block.l[0]);
	}
	...
	public void registerIcons(IconRegister icon) {
		blockIcon = icon.registerIcon(ModInfo.ID.toLowerCase() + ":" + BlockInfo.yellowColoredLightBlock_unlocalizedName);
	}
