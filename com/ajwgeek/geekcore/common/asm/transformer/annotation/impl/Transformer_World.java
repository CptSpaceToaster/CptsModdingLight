...
public abstract class Transformer_World extends World
{
	/* DO NOT use this method */
	public Transformer_World(ISaveHandler par1ISaveHandler, String par2Str, WorldSettings par3WorldSettings, WorldProvider par4WorldProvider, Profiler par5Profiler, ILogAgent par6ILogAgent)
	{
	...
	//XXX Check me on every update!
	@MethodReplace
	private int func_98179_a(int x, int y, int z, EnumSkyBlock par4EnumSkyBlock)
	{
	...
	@MethodReplace
	public void func_72936_c(EnumSkyBlock par1Enu, int x, int y, int z)
	{
		if (this.doChunksNearChunkExist(x, y, z, 17))
		{
			...
			int compLightValue = this.func_98179_a(x, y, z, par1Enu);
			long l1;
			int x1;
			int y1;
			int z1;
			...
			while (l < i1)
			{
				...
				expectedEntryLight = this.func_98179_a(x1, y1, z1, par1Enu);
