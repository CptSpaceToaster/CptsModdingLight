...
public class Block implements cpw.mods.fml.common.registry.BlockProxy
{
	...
	/** Light Value Helper **/
	public static Float[] l = {0F, 1F/15, 2F/15, 3F/15, 4F/15, 5F/15, 6F/15, 7F/15, 8F/15, 9F/15, 10F/15, 11F/15, 12F/15, 13F/15, 14F/15, 1F};
	...
	/**
	 * XXX Added because this needs to exist.... why doesn't it already?
	 * 
	 * @param par1
	 *            Integer Light Value 0 to 15
	 ...
	 * 
	 * @param itemList
	 *            The list of items to display on the creative inventory.
	 */
	@Deprecated
	 ...
	 *            The z position of this block instance
	 * @param side
	 *            The INPUT side of the block to be powered - ie the opposite of this block's output side
	...
	/**
	 * Adds more Data to the lightValue array Normal Light values range from Binary 0000 0000 0000 0000 0000 0000 0000 LLLL
	 * 
	 * This adds some more data in the form 0000 0000 0000 0BBBB 0GGGG 0RRRR 0LLLL
	 * 
	 * Note, by having a dim light, such as LLLL = 0001 = LightValue of 1, but giving it a color, then the value will still read as an insanely large integer.
	 * 
	 * By Adding 0011 into BBBB, a new integer reads like this 0000 0000 0000 00011 00000 00000 0LLLL, or a number ranging from 98304 to 98319 based on LLLL
	 * 
	 * Adding color will mess up a lot of stuff, just make sure you handle lightValue appropriatly
	 * 
	 * CptSpaceToaster
	 */
