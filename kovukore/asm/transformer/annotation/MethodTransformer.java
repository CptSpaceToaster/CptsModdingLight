package kovukore.asm.transformer.annotation;
...
public class MethodTransformer
{
	...
	{
		System.out.println("Looking For: " + replacementMethodNode.name);
		System.out.println("Description: " + replacementMethodNode.desc);
		...
		for (Object originalMethod : allMethods)
		{
			...
			System.out.println(": " + newMethodNode.name);
			System.out.println(": " + newMethodNode.desc);
			if (newMethodNode.name.equals(replacementMethodNode.name) && newMethodNode.desc.equals(replacementMethodNode.desc))
			{
