...
import kovukore.asm.transformer.manualTransformations.TransformerSingleMethodAppend;
import kovukore.asm.transformer.manualTransformations.UtilsASM;
...
public final class SetField_Block extends TransformerSingleMethod implements Opcodes
{
	...
	protected boolean transform(ClassNode clazz, MethodNode mv)
	{
		...
		mv.visitMethodInsn(INVOKESTATIC, "java/lang/Float", "valueOf", "(F)Ljava/lang/Float;");
		mv.visitInsn(AASTORE);
		mv.visitFieldInsn(PUTSTATIC, "com/ajwgeek/geekcore/common/asm/transformer/manualTransformations/kovukore.impl/SetField_Block", "l", "[Ljava/lang/Float;");
		mv.visitMaxs(4, 0);
		mv.visitEnd();
		return true;
	}
