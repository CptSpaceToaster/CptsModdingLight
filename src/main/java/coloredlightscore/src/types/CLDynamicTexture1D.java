...
public class CLDynamicTexture1D extends DynamicTexture {
    ...
    public static void allocateTextureImpl(int textureID, int mipmapLevel, int pWidth, float anUnusedFloatFromDynamicTexture) {
        ...
        if (mipmapLevel > 0) {
            GL11.glTexParameteri(GL11.GL_TEXTURE_1D, GL12.GL_TEXTURE_MAX_LEVEL, mipmapLevel);
            GL11.glTexParameterf(GL11.GL_TEXTURE_1D, GL12.GL_TEXTURE_MIN_LOD, 0.0F);
            GL11.glTexParameterf(GL11.GL_TEXTURE_1D, GL12.GL_TEXTURE_MAX_LOD, (float) mipmapLevel);
            GL11.glTexParameterf(GL11.GL_TEXTURE_1D, GL14.GL_TEXTURE_LOD_BIAS, 0.0F);
        }
    ...
    public void updateDynamicTexture() {
        ...
        //TextureUtil.dataBuffer.position(0).limit(textureLength + offset);
