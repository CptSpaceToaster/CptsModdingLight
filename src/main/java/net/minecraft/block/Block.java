...
public class Block
{
	...
	public boolean canSustainPlant(IBlockAccess world, int x, int y, int z, ForgeDirection direction, IPlantable plantable)
	{
		...
		case Water:
			return world.func_147439_a(x, y, z).func_149688_o() == Material.field_151586_h && world.getBlockMetadata(x, y, z) == 0;
		case Beach:
	 ...
	 *            Class
	 * @param level
	 *            Harvest level: Wood: 0 Stone: 1 Iton: 2 Diamond: 3 Gold: 0
	 */
